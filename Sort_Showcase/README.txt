	...
	it up in a neat HTML page for ease of use.
	...
	This next portion is just to help me keep organized with my objectives and what will be achieved for each ver.

	feel free to reach out to me to make suggestions

---Ver 1.00---

- establish basic 'index' page with HTML including a 'welcome' with above text as a reference point

- establish a basic Style sheet including style classes for "container", "Global" etc.
